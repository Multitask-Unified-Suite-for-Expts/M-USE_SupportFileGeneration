...
nSessions = 10
randomizeTaskOrder = 1;
iDifficultyLevel = 1 % for Frey
%iDifficultyLevel = 3 % for Wotan


iNAME_COMBINATION = 'MRT_FL_EC_VS'; % 42
% iNAME_COMBINATION = 'VS_EC_FL_MRT'; % 42
...
identifierStr = 'SESSIONCONFIGS_040ies';
...
for iSession  = 1:nSessions
    ...
    cfg.sessionName             = sprintf('%s_DF%d_v02_Set%02d',sessionName_Prefix, iDifficultyLevel, iSession);
    ...
    for iTaskNumber=tasksequence
        ...
        if iTaskNumber == 1
            ...
            if 1 %iDifficultyLevel == 1
                cfg.mz_difficultyLevel    = 1;
                cfg.mz_nMazes = 2;
            elseif 0 %iDifficultyLevel == 3
    ...
    if 0
        ...
        % --- Working Memory
        % --- --- --- --- --- --- --- --- --- --- ---
        [cfg] = make_configs_WorkingMemory_01(cfg)
